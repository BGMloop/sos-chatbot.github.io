...
export function ChatBox({ 
      ...
      if (file) {
        ...
        await sendFileRequest({
          ...
          onToken: (token) => {
            setMessages(prev => {
              const updated = [...prev];
              updated[responseIndex + 1] = {
                ...updated[responseIndex + 1],
                content: updated[responseIndex + 1].content + token
              };
              return updated;
            });
          },
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Error Message */}
      {error && (
        <div className="p-2 m-2 text-sm text-red-500 bg-red-50 rounded-md">
          {error}
        </div>
      )}
      ...
      {/* File Preview */}
      {file && (
        <div className="p-2 m-2 bg-gray-100 text-sm rounded-md flex justify-between items-center">
