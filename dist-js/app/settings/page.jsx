        ...
        <Card className="w-full">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-1">
              ...
              <p className="text-sm">{((_a = user === null || user === void 0 ? void 0 : user.primaryEmailAddress) === null || _a === void 0 ? void 0 : _a.emailAddress) || "No email available"}</p>
            </div>
            
            <div className="space-y-1">
              <Label className="font-medium">Username</Label>
              <p className="text-sm">{(user === null || user === void 0 ? void 0 : user.username) || (user === null || user === void 0 ? void 0 : user.fullName) || "No username available"}</p>
            </div>
          </CardContent>
        </Card>
      </div>
