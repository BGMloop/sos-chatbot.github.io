...
export default function LandingPage() {
    ...
    return (<main className="min-h-screen bg-gradient-to-b from-white to-gray-50/50 flex items-center justify-center">
      {/* Background pattern */}
      ...
      <section className="w-full px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col items-center space-y-10 text-center">
        ...
        <header className="space-y-4 pt-12 relative">
            <div className="group relative">
              <Image className="dark:invert mx-auto mt-1 mb-2 transition-transform duration-300 group-hover:scale-105" src="/logo/logo.png" alt="Logo.png logo" width={400} height={246} priority/>
              
              {/* Pre-conduction effect - subtle glow at the ground */}
              {showPreConduction && (<div className="absolute left-1/2 transform -translate-x-1/2 bottom-0 w-12 h-12 bg-gradient-radial from-white via-blue-200 to-violet-300 opacity-40 rounded-full blur-md animate-pulse"></div>)}
                  ...
                  <div className="absolute left-1/2 transform -translate-x-1/2 top-[100px] w-6 h-[500px] overflow-visible">
                    ...
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-24 h-12">
                      <svg viewBox="0 0 100 40" className="w-full h-full">
                        ...
                        <path d="M50,0 L30,10 L60,15 L25,25 L70,30 L40,40 L50,50" fill="none" stroke="url(#lightning-gradient)" strokeWidth="4" className="animate-lightning-flicker"/>
                      </svg>
                    </div>
                    ...
                    <div className="absolute top-[30%] left-0 w-16 h-8 ml-4 transform -rotate-30 opacity-80">
                      <svg viewBox="0 0 40 20" className="w-full h-full">
                        ...
                        <path d="M0,0 L20,5 L5,15 L30,20" fill="none" stroke="url(#branch1-gradient)" strokeWidth="2.5" className="animate-lightning-flicker"/>
                      </svg>
                    </div>
                    ...
                    <div className="absolute top-[50%] right-0 w-20 h-10 -mr-4 transform rotate-20 opacity-80">
                      <svg viewBox="0 0 40 20" className="w-full h-full">
                        ...
                        <path d="M0,0 L20,10 L5,15 L35,20" fill="none" stroke="url(#branch2-gradient)" strokeWidth="2.5" className="animate-lightning-flicker"/>
                      </svg>
                    </div>
                    ...
                    <div className="absolute top-[25%] right-2 w-12 h-6 transform rotate-45 opacity-70">
                      <svg viewBox="0 0 30 15" className="w-full h-full">
                        <path d="M0,0 L10,5 L5,10 L15,15" fill="none" stroke="rgba(255, 255, 255, 0.9)" strokeWidth="2" className="animate-lightning-flicker-fast"/>
                      </svg>
                    </div>
                    
                    <div className="absolute top-[65%] left-2 w-12 h-6 transform -rotate-30 opacity-70">
                      <svg viewBox="0 0 30 15" className="w-full h-full">
                        <path d="M0,0 L15,7 L5,10 L20,15" fill="none" stroke="rgba(168, 169, 230, 0.9)" strokeWidth="2" className="animate-lightning-flicker-fast"/>
                      </svg>
                    </div>
          ...
          <div className="mt-4">
            <SignedIn>
              <Link href="/dashboard">
                <button className="group relative inline-flex items-center justify-center px-8 py-3.5 text-base font-medium text-white bg-gradient-to-r from-indigo-600 to-black rounded-full hover:from-indigo-500 hover:to-black transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5" onClick={(e) => {
            triggerLightning();
        ...
        ].map(({ title, description }) => (<div key={title} className="text-center">
