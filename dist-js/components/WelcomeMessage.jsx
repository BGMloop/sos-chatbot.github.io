...
export default function WelcomeMessage() {
    ...
    return (<div className="flex flex-col items-center justify-center h-full mt-10 px-4 sm:px-0">
      <div className={`bg-white rounded-2xl shadow-sm ring-1 ring-inset ring-gray-200 px-4 sm:px-6 py-5 max-w-lg w-full transition-opacity duration-700 ease-in-out ${fadeIn ? 'opacity-100' : 'opacity-0'}`}>
        <div className="flex justify-center mb-4">
          <div className="relative w-[400px] h-[246px]">
            <Image src="/logo/logo.png" alt="AI Agent Chat Logo" fill sizes="400px" className="object-contain dark:invert" priority/>
          </div>
        </div>
        <h2 className="text-lg font-semibold text-gray-900 mb-3 text-center">
          Welcome {(user === null || user === void 0 ? void 0 : user.firstName) ? `${user.firstName}` : ''} to your FREE AI Agent Chat! 👋
        </h2>
