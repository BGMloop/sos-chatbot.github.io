...
// Define the types for the tool status data
...
interface ToolStatusData {
  results: Record<string, ToolStatus>;
  summary: {
    total: number;
    available: number;
    error: number;
...
export default function ToolStatusPage() {
  const [toolStatus, setToolStatus] = useState<ToolStatusData | null>(null);
  ...
  const sortTools = (a: [string, ToolStatus], b: [string, ToolStatus]) => 
